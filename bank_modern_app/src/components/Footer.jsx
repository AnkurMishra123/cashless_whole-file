...
const Footer = () => (
  ...
  ${styles.paddingY} flex-col`}>
    ...
    <div className="flex-1 flex flex-col justify-start mr-10">
      ...
      payments easy, realiable and secure.</p>
    </div>
            ...
            <ul className="list-none mt-4">
              {footerLink.links.map((Link, index) => (
                ...
                text-[16px] leading-[24px] text-dimWhite
                 hover:text-secondary cursor-pointer ${index !== footerLink.links.length - 1 ? 'mb-4' : "mb-8"}`}>
                    {Link.name}
                </li>
              ))}
            </ul>
...
md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45] ">
  <p className="font-poppins font-normal text-center text-[18px] 
            leading-[27px] text-white "> 2022 Hookbank. All Rights reversed.</p>
<div className="flex flex-row md:mt-0 ml-6">
